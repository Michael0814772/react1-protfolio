  ...
  return (
    <div className="universalbodypadding pt-11 pb-20">
      <div className="text-center mb-16">
        <h1 className="text-textcl2 text-3xl mb-2">
          Other Noteworthy Projects
        </h1>
        <p className="text-center text-base text-textcl1 cursor-pointer">
          view the archive
        </p>
      </div>
        ...
        <ul className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:col-span-3">
          {noteWorthyProjects.map((projects) => (
            ...
            >
              ...
              <div>
                <div className="pb-7">
                  <h1 className="pb-7 text-textcl2 group-hover:text-textcl1 text-3xl xl:text-4xl leading-9">
                    {projects.name}
                  </h1>
                  <p className="text-sm xl:text-xl text-textcl4">
                    {projects.summary}
                  </p>
                </div>
                <div>
