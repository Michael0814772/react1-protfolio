const workFunctions = [
    {
        ...
        functions: {
            function1: 'Write modern, performant, maintainable code for a diverse array of client and internal projects',
            function2: 'Work with a variety of different languages, platforms, frameworks, and content management systems such as JavaScript, TypeScript, Gatsby, React, Craft, WordPress, Prismic, and Netlify',
            function3: 'Communicate with multi-disciplinary teams of engineers, designers, producers, and clients on a daily basis'
        },
        id: 1
    },
    {
        ...
        functions: {
            ...
            function3: 'Interfaced with clients on a weekly basis, providing technological expertise'
        },
        id: 2
    },
    {
